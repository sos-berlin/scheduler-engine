...
namespace zschimmer { namespace javabridge { 
    ...
    template<> const class_factory<Java_proxy_class> has_java_proxy< ::sos::scheduler::Job >::java_proxy_class_factory("com.sos.scheduler.kernel.core.cppproxy.JobCImpl");
...
namespace zschimmer { namespace javabridge { 
    ...
    template<> void has_java_proxy< ::sos::scheduler::Job>::register_cpp_proxy_class_in_java() {
        Env env;
