...
{ 
    // Thread entfernt Task die Task, wenn er die Schleife ¸ber die _task_list beendet hat. _thread->remove_task( this );  
    _thread = NULL; 
}
...
{ 
    return _operation? _timeout == latter_day? latter_day
                                             : Time( _next_time + _timeout )     // _timeout sollte nicht zu groﬂ sein
                     : _next_time;
}
