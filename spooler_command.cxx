// $Id: spooler_command.cxx,v 1.136 2004/08/26 22:24:52 jz Exp $
/*
...
"<!-- $Rev$ $Date: 2004/08/26 22:24:52 $  Joacim Zschimmer,  (C) 2000 SOS GmbH Berlin  -->\n"
"\n"
"\n"
...
"<!ATTLIST thread                spooler_id          CDATA #IMPLIED>     <!- - '': Thread läuft auf jedem Spooler, sonst nur Spooler mit derselben Spooler-Id - ->\n"
...
"<!ATTLIST thread                priority            CDATA #IMPLIED>     <!- - Windows Thread-Priorität, relativ zur Prozessprioritätsklasse, 'idle' oder '-15' bis '+2' - ->\n"
"-->\n"
"\n"
"<!ELEMENT jobs                  ( job+ )>\n"
"\n"
"<!ELEMENT job                   ( description?, params?, ( object_set | script | process )?, run_time? )>\n"
...
"<!ATTLIST add_order             title               CDATA #REQUIRED>\n"
"<!-- .... -->\n"
"                                                                                   <!-- Antwort: <ok> -->\n"
"\n"
"<!ELEMENT show_state            EMPTY>                                             <!-- Liefert den Zustand des Spoolers -->\n"
"<!ATTLIST show_state            what                ( standard\n"                    
"                                                    | all\n"
"                                                    | description \n"
"                                                    | job_chain_ordes\n"
"                                                    | log\n"
...
"<!ATTLIST show_history          what                (standard|all) #IMPLIED>       <!-- what='' ist wie what='standard', what='all' liefert <description> -->\n"
...
void Command_processor::execute_2( const string& xml_text, const Time& xml_mod_time )
{
    try 
    {
        ...
        //Wir validieren nur <config> (s. load_config). Denn libxml2 liefert #IMPLIED wie "" und das macht uns die Kommandos kaputt.
