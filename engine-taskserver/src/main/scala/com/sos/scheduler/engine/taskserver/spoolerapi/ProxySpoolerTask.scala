...
import com.sos.scheduler.engine.minicom.idispatch.{AnnotatedInvocable, DISPID, InvocableIDispatch}
...
extends SpoolerTask with SpecializedProxyIDispatch with AnnotatedInvocable with InvocableIDispatch {
