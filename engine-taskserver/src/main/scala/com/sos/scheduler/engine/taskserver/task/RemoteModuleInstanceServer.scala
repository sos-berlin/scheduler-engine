...
import com.sos.scheduler.engine.minicom.idispatch.{AnnotatedInvocable, IDispatch, IUnknownFactory, SimpleInvocableIDispatch}
...
extends HasCloser with AnnotatedInvocable with SimpleInvocableIDispatch {
