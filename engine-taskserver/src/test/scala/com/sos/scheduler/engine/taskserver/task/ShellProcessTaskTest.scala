...
import com.sos.scheduler.engine.minicom.idispatch.{IDispatch, Invocable, InvocableIDispatch, PublicMethodsInvocable}
...
private object ShellProcessTaskTest {
  ...
  private class TestSpoolerLog extends SpoolerLog with PublicMethodsInvocable with InvocableIDispatch {
