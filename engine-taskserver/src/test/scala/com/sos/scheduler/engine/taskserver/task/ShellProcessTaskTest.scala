...
import com.sos.scheduler.engine.minicom.idispatch.{IDispatch, Invocable, SimpleInvocableIDispatch, PublicMethodsAreInvocable}
...
private object ShellProcessTaskTest {
  ...
  private class TestSpoolerLog extends SpoolerLog with PublicMethodsAreInvocable with SimpleInvocableIDispatch {
