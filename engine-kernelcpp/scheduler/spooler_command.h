// $Id: spooler_command.h 14628 2011-06-20 09:40:12Z ss $        Joacim Zschimmer, Zschimmer GmbH, http://www.zschimmer.com
...
struct Command_processor
{
    ...
    xml::Element_ptr            execute_remote_scheduler_remote_task_kill_or_close(const xml::Element_ptr&);
    ...
    xml::Element_ptr            execute_setting_set        (const xml::Element_ptr& element);
