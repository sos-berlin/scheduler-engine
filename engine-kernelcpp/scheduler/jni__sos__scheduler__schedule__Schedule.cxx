...
static jstring JNICALL file_1based_1state_1name(JNIEnv* jenv, jobject, jlong cppReference)
{
    Env env = jenv;
    try {
        ::sos::scheduler::schedule::Schedule* o_ = has_proxy< ::sos::scheduler::schedule::Schedule >::of_cpp_reference(cppReference,"::sos::scheduler::schedule::Schedule::file_based_state_name()");
