...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-930", "Task $1 started - cause: $2, process class '$3'" },
    ...
    { "SCHEDULER-949", "Execution is deferred a process of process class '$1' becomes available" },
    ...
    { "SCHEDULER-842", "Task is going to process $1, state=$2, on JobScheduler '$3'$4" },
