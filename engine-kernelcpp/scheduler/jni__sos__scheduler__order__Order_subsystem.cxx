...
static void JNICALL add_1distributed_1to_1order_1statistics__Ljava_lang_String_2_3I(JNIEnv* jenv, jobject, jlong cppReference, jstring p0, jintArray p1)
{
    Env env = jenv;
    try {
        ::sos::scheduler::order::Order_subsystem* o_ = has_proxy< ::sos::scheduler::order::Order_subsystem >::of_cpp_reference(cppReference,"::sos::scheduler::order::Order_subsystem::add_distributed_to_order_statistics()");
        (o_->add_distributed_to_order_statistics(env.string_from_jstring(p0), p1));
    }
...
static void JNICALL add_1non_1distributed_1to_1order_1statistics___3I(JNIEnv* jenv, jobject, jlong cppReference, jintArray p0)
{
    Env env = jenv;
    try {
        ::sos::scheduler::order::Order_subsystem* o_ = has_proxy< ::sos::scheduler::order::Order_subsystem >::of_cpp_reference(cppReference,"::sos::scheduler::order::Order_subsystem::add_non_distributed_to_order_statistics()");
...
static void JNICALL java_1for_1each_1distributed_1order__Ljava_util_ArrayList_2Ljava_util_ArrayList_2ILcom_sos_scheduler_engine_kernel_order_OrderCallback_2(JNIEnv* jenv, jobject, jlong cppReference, jobject p0, jobject p1, jint p2, jobject p3)
{
    Env env = jenv;
    try {
        ...
        (o_->java_for_each_distributed_order(::javaproxy::java::util::ArrayList(p0), ::javaproxy::java::util::ArrayList(p1), p2, ::javaproxy::com::sos::scheduler::engine::kernel::order::OrderCallback(p3)));
    }
    catch(const exception& x) {
        env.set_java_exception(x);
    }
...
const static JNINativeMethod native_methods[] = {
    { (char*)"add_distributed_to_order_statistics__native", (char*)"(JLjava/lang/String;[I)V", (void*)::javaproxy::com::sos::scheduler::engine::kernel::cppproxy::add_1distributed_1to_1order_1statistics__Ljava_lang_String_2_3I },
    ...
    { (char*)"java_for_each_distributed_order__native", (char*)"(JLjava/util/ArrayList;Ljava/util/ArrayList;ILcom/sos/scheduler/engine/kernel/order/OrderCallback;)V", (void*)::javaproxy::com::sos::scheduler::engine::kernel::cppproxy::java_1for_1each_1distributed_1order__Ljava_util_ArrayList_2Ljava_util_ArrayList_2ILcom_sos_scheduler_engine_kernel_order_OrderCallback_2 }
};
