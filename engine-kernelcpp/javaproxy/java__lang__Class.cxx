...
struct Class__class : ::zschimmer::javabridge::Class
{
   ...
   ~Class__class();
    ...
    ::zschimmer::javabridge::Method const _getTypeName____method;
    ...
    ::zschimmer::javabridge::Method const _toGenericString____method;
...
Class__class::Class__class(const string& class_name) :
    ...
    ,_getTypeName____method(this, "getTypeName", "()Ljava/lang/String;")
    ...
    ,_toGenericString____method(this, "toGenericString", "()Ljava/lang/String;")
...
::javaproxy::java::lang::String Class::getTypeName() const {
    ::zschimmer::javabridge::raw_parameter_list<0> parameter_list;
    Class__class* cls = _class.get();
    ::javaproxy::java::lang::String result;
    result.steal_local_ref(cls->_getTypeName____method.jobject_call(get_jobject(), parameter_list));
    return result;
}
...
::javaproxy::java::lang::String Class::toGenericString() const {
    ::zschimmer::javabridge::raw_parameter_list<0> parameter_list;
    Class__class* cls = _class.get();
    ::javaproxy::java::lang::String result;
    result.steal_local_ref(cls->_toGenericString____method.jobject_call(get_jobject(), parameter_list));
    return result;
}
