...
struct HashMap : ::zschimmer::javabridge::proxy_jobject< HashMap >, ::javaproxy::java::util::AbstractMap {
  ...
  public:
    ...
    ::javaproxy::java::lang::Object getOrDefault(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p1) const;
    bool isEmpty() const;
    ...
    ::javaproxy::java::lang::Object putIfAbsent(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p1) const;
    ::javaproxy::java::lang::Object remove(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0) const;
    bool remove(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p1) const;
    ::javaproxy::java::lang::Object replace(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p1) const;
    bool replace(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p1, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::Object >& p2) const;
    jint size() const;
