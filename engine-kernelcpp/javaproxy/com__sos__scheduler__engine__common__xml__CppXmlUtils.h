...
#ifndef _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_XML_CPPXMLUTILS_H_
#define _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_XML_CPPXMLUTILS_H_
...
struct CppXmlUtils__class;

struct CppXmlUtils : ::zschimmer::javabridge::proxy_jobject< CppXmlUtils >, ::javaproxy::java::lang::Object {
  private:
    static CppXmlUtils new_instance();  // Not implemented
  public:

    CppXmlUtils(jobject = NULL);

    CppXmlUtils(const CppXmlUtils&);

    #ifdef Z_HAS_MOVE_CONSTRUCTOR
        CppXmlUtils(CppXmlUtils&&);
    #endif

    ~CppXmlUtils();

    CppXmlUtils& operator=(jobject jo) { assign_(jo); return *this; }
    CppXmlUtils& operator=(const CppXmlUtils& o) { assign_(o.get_jobject()); return *this; }
    #ifdef Z_HAS_MOVE_CONSTRUCTOR
        CppXmlUtils& operator=(CppXmlUtils&& o) { set_jobject(o.get_jobject()); o.set_jobject(NULL); return *this; }
    #endif

    jobject get_jobject() const { return ::zschimmer::javabridge::proxy_jobject< CppXmlUtils >::get_jobject(); }

  protected:
    void set_jobject(jobject jo) {
        ::zschimmer::javabridge::proxy_jobject< CppXmlUtils >::set_jobject(jo);
  ...
  private:
    struct Lazy_class : ::zschimmer::abstract_lazy<CppXmlUtils__class*> {
