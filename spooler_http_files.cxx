...
const char file_jz_scheduler_xslt[] = 
    ...
    "\x00" "<td><xsl:value-of select=\"@idle_since__xslt_datetime_with_diff\"  disable-output-escaping=\"yes\"/></td>\n"
    "</tr>\n"
    "</xsl:when>\n"
    "<xsl:otherwise>\n"
    "<tr>\n"
...
const char file_jz_scheduler_css[] = 
    ...
    "\n"
    ".remote_scheduler               { background-color: #ffff80 }\n"
    ".remote_scheduler_hover         { background-color: #ffffc0 }\n"
    "\n"
    "/* Anklickbar */\n"
