// $Id$
// ACHTUNG: NICHT AENDERN! DIESE DATEI IST GENENIERT VON files_to_c++.pl
...
const char file_jz_browser_dependencies_js[] = 
    ...
    "{\n"
    "\x09" "Document.prototype.__defineGetter__\n"
    "\x09" "( \n"
    "\x09" "    \"xml\", \n"
    "\x09" "    \n"
    "\x09" "    function()\n"
    "\x09" "    {\n"
    "\x09" "\x09" "    return new XMLSerializer().serializeToString( this );\n"
    "\x09" "    } \n"
    "\x09" ");\n"
    "}\n"
    "\x09" "\n"
    ...
    "{\n"
    "\x09" "Element.prototype.__defineGetter__\n"
    "\x09" "( \n"
    "\x09" "    \"xml\", \n"
    "\x09" "    \n"
    "\x09" "    function()\n"
    ...
    "\x09" "\x09" "return new XMLSerializer().serializeToString( xslt_processor.transformToDocument( this ) );\n"
    "}\n"
    "}\n"
    "\n"
    "//-------------------------------------------------------------------------------------------------\n"
...
const char file_jz_scheduler_xslt[] = 
    ...
    "<xsl:element name=\"td\">\n"
    "<xsl:attribute name=\"style\">\n"
    "padding-left: 3ex; white-space: nowrap;\n"
    "<xsl:if test=\"@task\">\n"
    "font-weight: bold;\n"
    "</xsl:if>\n"
    ...
    "This order is going to replace a currently processed order with same ID\n"
    "</xsl:attribute>\n"
    "</xsl:if>\n"
    "\n"
...
struct Inline_files { const char* filename; const char* content; int length; };

const Inline_files inline_files[] = 
{
    { "jz/details_frame.html", file_jz_details_frame_html, sizeof file_jz_details_frame_html - 1 },
    { "jz/index.html", file_jz_index_html, sizeof file_jz_index_html - 1 },
    { "jz/left_frame.html", file_jz_left_frame_html, sizeof file_jz_left_frame_html - 1 },
    { "jz/browser_dependencies.js", file_jz_browser_dependencies_js, sizeof file_jz_browser_dependencies_js - 1 },
    { "jz/popup_menu.js", file_jz_popup_menu_js, sizeof file_jz_popup_menu_js - 1 },
    { "jz/scheduler.js", file_jz_scheduler_js, sizeof file_jz_scheduler_js - 1 },
    { "jz/show_log.js", file_jz_show_log_js, sizeof file_jz_show_log_js - 1 },
    { "jz/translation_de.js", file_jz_translation_de_js, sizeof file_jz_translation_de_js - 1 },
    { "jz/scheduler.xslt", file_jz_scheduler_xslt, sizeof file_jz_scheduler_xslt - 1 },
    { "jz/scheduler.css", file_jz_scheduler_css, sizeof file_jz_scheduler_css - 1 },
    { NULL, NULL, 0 }
};
