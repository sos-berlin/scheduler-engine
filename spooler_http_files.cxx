...
const char file_jz_scheduler_xslt[] = 
    ...
    "<tr>\n"
    "<td>start at</td>\n"
    "\x00" "<td><xsl:value-of select=\"my:format_datetime_with_diff( string( @start_at ), $now, 0 )\"  disable-output-escaping=\"yes\"/></td>\n"
    "</tr>\n"
    "</xsl:if>\n"
    "-->\n"
    "<xsl:choose>\n"
