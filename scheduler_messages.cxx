...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-357", "This is member of a cluster (option -exclusive or -distributed-orders), and therefore needs a database" },
    ...
    { "SCHEDULER-426", "Job chain group cannot be set up, because of duplicate order id '$1' in '$2' and '$3'" },
    ...
    { "SCHEDULER-827", "Own heart beat is late: next_heart_beat has been announced for $1 (this is $2seconds late)" },
    ...
    { "SCHEDULER-872", "This Job_chain_group contains Job_chain $1" },
    { "SCHEDULER-873", "'$1' has been removed from Job_chain_group" },
    { "SCHEDULER-874", "Job_chain_group has been removed" },
    {}
};
} //namespace sos
} //namespace scheduler
