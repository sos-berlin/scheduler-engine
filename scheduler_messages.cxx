...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-993", "No heart beat from active Scheduler member $1, although it announced one for $2 ($3s ago)" },
    { "SCHEDULER-994", "No heart beat since $3s ($2) of active Scheduler member $1" },
    { "SCHEDULER-995", "The exclusive Scheduler seems to be $1 (pid=$4, $3), claiming its last heart beat was $2s ago" },
    ...
    { "SCHEDULER-805", "No Scheduler is exclusive" },
