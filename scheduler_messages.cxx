...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-800", "Waiting for main Scheduler member to start" },
    { "SCHEDULER-801", "Waiting for active Scheduler member to become inactive" },
    { "SCHEDULER-802", "Active Scheduler member is terminated properly, so this inactive Scheduler member terminates too" },
    ...
    { "SCHEDULER-993", "Scheduler member $1's heart does not beat since $2, expected next_heart_beat at $3" },
    { "SCHEDULER-994", "Scheduler member $1's heart does not beat since $2, after period of $3s has elapsed" },
    { "SCHEDULER-995", "Active Scheduler member is $1, $2" },
    { "SCHEDULER-996", "Heart beat is too late: announced next_heart_beat was $1 ($2s ago)" },
    { "SCHEDULER-997", "This Scheduler member becomes active now" },
    { "SCHEDULER-998", "Active Scheduler member is $1" },
