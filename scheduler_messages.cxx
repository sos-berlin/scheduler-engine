...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-381", "Scheduler is not activated (in backup mode) and can not execute the operation" },
    ...
    { "SCHEDULER-994", "No heart beat since $2s ($1)" },
    { "SCHEDULER-995", "No heart beat since $2s ($1), Scheduler seems to be dead" },
    { "SCHEDULER-996", "No heart beat since $2s ($1), ignored because of recent database reconnect" },
    ...
    { "SCHEDULER-833", "Watching heart beat of that exclusive Scheduler, ready to take over operation" },
