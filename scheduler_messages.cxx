...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-357", "This is an exclusive or distributed Scheduler, and therefore needs a database" },
    ...
    { "SCHEDULER-382", "File orders can not be distributed" },
    ...
    { "SCHEDULER-995", "No heart beat since $2s ($1), ignored within $3s because of recent database reconnect" },
    ...
    { "SCHEDULER-809", "According to database, the Scheduler is up since $1" },
    ...
    { "SCHEDULER-832", "Waiting for start of Scheduler" },
