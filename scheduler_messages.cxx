...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-109", "Job '$1' is not initialized" },
    ...
    { "SCHEDULER-367", "Scheduler aborts because it has lost its exclusiveness" },
    ...
    { "SCHEDULER-378", "After own late heart beat, this Scheduler has been deactived and the occupied orders are freed by Scheduler member '$1'" },
    ...
    { "SCHEDULER-994", "No heart beat since $2s ($1), expecting heart beat within $3s" },
    { "SCHEDULER-995", "No heart beat since $2s ($1), ignored for $3s because of recent database reconnect" },
    { "SCHEDULER-996", "No heart beat since $2s ($1), Scheduler seems to be dead" },
    ...
    { "SCHEDULER-835", "This Scheduler becomes exclusive now" },
    ...
    { "SCHEDULER-851", "After possibly volatile error (number $1), the causing SQL statement will be repeated: $2" },
