...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-995", "No heart beat since $2s ($1), it seems to be dead" },
    { "SCHEDULER-996", "Own heart beat is late: next_heart_beat has been announced for $1 (this is $2s late)" },
    ...
    { "SCHEDULER-800", "Waiting for start of Scheduler" },
    { "SCHEDULER-801", "Watching exclusive Scheduler $1" },
    { "SCHEDULER-802", "Active Scheduler has terminated properly" },
    { "SCHEDULER-803", "This Scheduler becomes exclusive now" },
    ...
    { "SCHEDULER-818", "Active Scheduler has been started, so this inactive Scheduler starts again too" },
    { "SCHEDULER-819", "Scheduler becomes active" },
    { "SCHEDULER-820", "Watching Scheduler member" },
