...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-346", "Due to previous error the path is set on the bad list: $1" },
    { "SCHEDULER-347", "Path ist removed from the bad list: $1" },
    { "SCHEDULER-348", "Database doesn't deliver witdh of column $1.$2" },
