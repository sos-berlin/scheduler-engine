...
const char file_doc_log_categories_xml[] = 
    "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    "\n"
    "<log_category name=\"all\"            title=\"Alle Kategorien (au\xc3" "\x9f" "er nur explizite)\">\n"
    "</log_category>\n"
    "\n"
    "<!--\n"
    ...
    "<log_category name=\"*\"              global_default=\"on\" title=\"Alle Fehlercodes\"/>\n"
    "<log_category name=\"D310\"           local_default=\"off\" title=\"Dateiende\"/>\n"
    "<log_category name=\"D311\"           local_default=\"off\" title=\"Satz nicht gefunden\"/>\n"
    "</log_category>\n"
    "\n"
    ...
    "</log_category>\n"
    "\n"
    "<log_category name=\"hostole\"        title=\"Hostole-Aufrufe (au\xc3" "\x9f" "er Factory Processor)\">\n"
    "</log_category>\n"
    "\n"
    ...
    "</log_category>\n"
    "\n"
    "<log_category name=\"mutex\"          local_default=\"off\" title=\"Mutual exclusion locks, Sperren zur Serialisierung von Threads\">\n"
    "</log_category>\n"
    "\n"
    ...
    "</log_category>\n"
    "\n"
    "<log_category name=\"scheduler\"      local_default=\"on\" title=\"Scheduler\">\n"
    "<log_category name=\"call\"           local_default=\"on\"  title=\"Beginn und Ende des Aufrufs einer Jobmethode, z.B. spooler_process()\"/>\n"
    ...
    "<log_category name=\"order\"          local_default=\"on\"  title=\"Operation auf Auftr\xc3" "\xa4" "ge (zurzeit Setzen der Payload)\"/>\n"
    ...
    "<log_category name=\"data\"       local_default=\"off\" title=\"Daten von recv() und send()\"/>\n"
    "</log_category>\n"
    "\n"
    "<log_category name=\"spidermonkey\"   title=\"JavaScript-Implementierung Spidermonkey\">\n"
    "<log_category name=\"callback\"       local_default=\"off\"  title=\"R\xc3" "\xbc" "ckrufe von Spidermonkey\"/>\n"
    "<log_category name=\"idispatch\"      local_default=\"off\"  title=\"Verwaltung der COM-Objekte\"/>\n"
    "</log_category>\n"
    "\n"
    ...
    "</p>\n"
    "<p>\n"
    "Die Log-Kategorien geben Sie vor dem Dateinamen an, wobei dem Dateinamen ein Gr\xc3" "\xb6" "\xc3" "\x9f" "erzeichen (>) vorangestellt sein muss.\n"
    ...
    "</p>\n"
    "<p>\n"
    "Die besondere Kategorie <code>all</code> w\xc3" "\xa4" "hlt alle Kategorien aus, au\xc3" "\x9f" "er die, die explizit angegeben werden m\xc3" "\xbc" "ssen.\n"
    "</p>\n"
    "<p>\n"
