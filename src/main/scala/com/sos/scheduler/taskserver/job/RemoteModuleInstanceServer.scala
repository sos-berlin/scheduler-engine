package com.sos.scheduler.taskserver.job

import com.sos.scheduler.engine.common.scalautil.Logger
import com.sos.scheduler.taskserver.comrpc._
import com.sos.scheduler.taskserver.comrpc.types.{CLSID, EmptyVariant, IID, VariantArray}
import com.sos.scheduler.taskserver.configuration.IUnknownFactory
import com.sos.scheduler.taskserver.task.{ShellScriptTask, Task}
...
final class RemoteModuleInstanceServer extends IDispatch {
  import com.sos.scheduler.taskserver.job.RemoteModuleInstanceServer._
...
object RemoteModuleInstanceServer extends IUnknownFactory[RemoteModuleInstanceServer] {
