...
import com.sos.scheduler.engine.minicom.idispatch.{DISPID, IDispatch, IDispatchable}
...
private[remoting] final case class CreateInstanceResult(iDispatch: IDispatchable)
extends Result
