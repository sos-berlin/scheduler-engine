...
public class DatabaseQueryPluginTest extends SchedulerTest {
    ...
    private void waitForTaskTermination() throws Exception {
        ...
        Thread.sleep(10*1000);   // TODO Besser TerminatedTaskEvent abwarten, aber das haben wir noch nicht.
    }


//    @Ignore
    @Test
//  TODO Dieser Test sollte sobald wie möglich wieder aktiviert werden. Derzeit gibt es Probleme mit dem Datenbankzugriff.
