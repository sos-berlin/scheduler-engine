// $Id: popup_menu.js,v 1.2 2004/12/02 19:43:34 jz Exp $
...
//------------------------------------------------------------------Popup_menu_builder.create_popup

Popup_menu_builder.prototype.create_popup = function()
{
    if( !this._popup )
    {
...
//-------------------------------------------------------------------Popup_menu_builder.show_popup 

Popup_menu_builder.prototype.show_popup = function()
{
    this.create_popup();
...
{
    this._html_array = new Array();
    this._html_array.push( "<select name='__popupmenu_select'>" );
    this._html_array.push( "<option table cellpadding='0' cellspacing='0' width='100%'" +
                                 " style='background-color: menu; line-height: 12pt; font-family: Tahoma, Sans-Serif; font-size: 8pt; border: thin outset'>" );
    this._finished = false;
}
