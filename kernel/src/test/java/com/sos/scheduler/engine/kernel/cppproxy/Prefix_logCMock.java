...
public class Prefix_logCMock extends CppProxyImpl<Sister> implements Prefix_logC
{
    ...
    @Override public void error(String line)  { logLine("ERROR", line); }

    @Override public void warn(String line)   { logLine("WARN", line); }

    @Override public void info(String line)   { logLine("info", line); }

    @Override public void debug3(String line) { logLine("debug3", line); }
