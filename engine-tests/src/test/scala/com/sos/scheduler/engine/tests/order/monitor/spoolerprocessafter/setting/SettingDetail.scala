...
final case class SpoolerProcessBefore(result: MethodResult, details: MethodDetail*) extends Method(SpoolerProcessBeforeNames, result, details: _*) {
  require(result == Returns(false))
}
