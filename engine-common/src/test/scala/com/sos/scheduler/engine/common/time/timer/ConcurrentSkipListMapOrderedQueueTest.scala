...
final class ConcurrentSkipListMapOrderedQueueTest extends FreeSpec {
...
object ConcurrentSkipListMapOrderedQueueTest {
  private val logger = Logger(getClass)

  private def newOrderedQueue(): OrderedQueue[java.lang.Integer, Thing] =
    new ConcurrentSkipListMapOrderedQueue((_: Thing).criterion: Integer)
