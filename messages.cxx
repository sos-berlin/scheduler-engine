...
extern Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-263", "Error when opening the data base: $1" },
    { "SCHEDULER-264", "(german only) Fehler beim Schlieﬂen der Datenbank" },
    { "SCHEDULER-265", "SCHEDULER TERMINATES DUE TO A PROBLEM WITH THE DATABASE: $1" },
    ...
    { "SCHEDULER-271", "In favour of job $1 the task is terminated" },
    { "SCHEDULER-272", "Terminating task after reaching deadline" },
    { "SCHEDULER-273", "Killing subprocess $1" },
    { "SCHEDULER-274", "Error when killing subprocess $1: $2" },
    { "SCHEDULER-275", "Killing subprocess after reaching deadline" },
    ...
    { "SCHEDULER-280", "(german only) Prozess hat mit Exit code $1 (0x$2) geendet" },
    { "SCHEDULER-281", "Killing process" },
    { "SCHEDULER-282", "end(kill_immediately=true) called, task will be killed" },
    ...
    { "SCHEDULER-286", "More than $2 communication channels. Connection denied" },
    { "SCHEDULER-287", "TCP connection not allowed" },
    { "SCHEDULER-288", "-reuse-port: Using $1, but another application can use it too" },
    { "SCHEDULER-289", "$1 is blocked. Trying $2 seconds" },
    { "SCHEDULER-290", "Deadline reached, cancelling HTTP operation" },
    { "SCHEDULER-291", "When removing protocol file: $1" },
    { "SCHEDULER-292", "Missing from, to, subject or body. Supressing email" },
    ...
    { "SCHEDULER-", "(german only) " },
    { "SCHEDULER-900", "Scheduler $1 starting with $2, pid=$3" },
    ...
    { "SCHEDULER-909", "Creating database table $2" },
    { "SCHEDULER-910", "New history file opened: $1" },
    { "SCHEDULER-912", "add_pid($1), deadline is $2" },
    ...
    { "SCHEDULER-945", "End state reached, order finished" },
    ...
    { "SCHEDULER-951", "Daylight saving time starts" },
    { "SCHEDULER-952", "Daylight saving time ends" },
    { "SCHEDULER-953", "Still waiting $1 seconds ..." },
    { "SCHEDULER-954", "XSLT stylesheet $1 $1 returns:" },
    { "SCHEDULER-955", "UDP message from $1: $2" },
    { "SCHEDULER-956", "Scheduler expects command from $1 port $2 " },
    { "SCHEDULER-957", "Closing database" },
    { "SCHEDULER-958", "Waiting a minute before opening the database again" },
