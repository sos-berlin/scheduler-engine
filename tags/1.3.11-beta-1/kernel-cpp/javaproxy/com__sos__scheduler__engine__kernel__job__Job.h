...
struct Job : ::zschimmer::javabridge::proxy_jobject< Job >, ::javaproxy::com::sos::scheduler::engine::kernel::AbstractHasPlatform {
  private:
  ...
  public:
    ...
    ::javaproxy::java::lang::String name();
    void onCppProxyInvalidated();
    ::javaproxy::java::lang::String path();
