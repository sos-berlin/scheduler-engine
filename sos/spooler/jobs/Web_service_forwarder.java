...
public class Web_service_forwarder  extends sos.spooler.Job_impl
{
    ...
    class Process
    {
        ...
        private Document apply_xslt_stylesheet( File stylesheet_file, Document order_document )  throws Exception
        {
              ...
              //else
                ...
                if( response_code != HttpURLConnection.HTTP_OK 
                 && response_code != HttpURLConnection.HTTP_ACCEPTED )
                    throw new Order_exception( http_connection.getResponseMessage() );
