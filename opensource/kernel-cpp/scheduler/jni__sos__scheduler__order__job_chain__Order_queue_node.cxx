...
static void JNICALL set_1action__Ljava_lang_String_2(JNIEnv* jenv, jobject, jlong cppReference, jstring p0)
{
    Env env = jenv;
    try {
        ::sos::scheduler::order::job_chain::Order_queue_node* o_ = has_proxy< ::sos::scheduler::order::job_chain::Order_queue_node >::of_cpp_reference(cppReference,"::sos::scheduler::order::job_chain::Order_queue_node::set_action()");
