// $Id: directory_observer.h 14013 2010-09-14 07:21:33Z ss $        Joacim Zschimmer, Zschimmer GmbH, http://www.zschimmer.com
...
struct Directory : Object
{
  ...
  //Directory*                  subdirectory                ( const string& name ) const;
    ...
    bool                        is_directory_to_observe     ( const File_path );
