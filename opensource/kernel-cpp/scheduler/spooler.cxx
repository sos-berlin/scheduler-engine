...
{
    #if !defined Z_USE_JAVAXML
        // Java-Optionen und classpath sind nicht in <base> m̦glich, siehe Meldung SCHEDULER-475.
...
string Spooler::backup_logfile( const File_path path )
{
   ...
   if( path.file_exists() )
   {
         ...
         File_path scheduler_old = (i > 0) ? path.substr(0,i) + "-old." + path.extension() : path + "-old";
         try
         {
