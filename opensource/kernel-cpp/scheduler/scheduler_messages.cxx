...
Message_code_text scheduler_messages[] =
{
    ...
    { "SCHEDULER-260", "Error in JobScheduler Skript, spooler_exit(): $1Error in JobScheduler script, spooler_exit(): $1" },
    ...
    { "SCHEDULER-314", "Cannot open database. JobScheduler is aborting immediately because of need_db=$1" },
    ...
    { "SCHEDULER-458", "Remote JobScheduler has not sent a notification for $1s and has been deregistered" },
    ...
    { "SCHEDULER-474", "Workload JobScheduler is not responding to UDP message since $1 ($2s). Workload scheduler's configuration can not be updated." },
