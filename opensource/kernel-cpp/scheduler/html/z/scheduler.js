// $Id: scheduler.js 13743 2008-12-12 08:53:40Z jz $
...
function task_menu__onclick( job_path, task_id, x, y )
{
    ...
    popup_builder.add_bar();
    popup_builder.add_command ( "End"             , "<kill_task" + xml_attribute( "job", job_path ) + " id='" + task_id + "'/>" );
  ...
  //popup_builder.add_command ( "Continue"        , "<modify_task id='" + task_id + "'/> cmd='continue'" );
    popup_builder.add_command ( "Kill immediately", "<kill_task" + xml_attribute( "job", job_path ) + " id='" + task_id + "' immediately='yes'/>" );
...
function order_menu__onclick( job_chain_name, order_id, x, y )
{
  ...
  //popup_builder.add_command ( "setback=no"      , "<modify_order job_chain='" + xml_encode_attribute( job_chain_name ) + "' order='" + xml_encode_attribute( order_id ) + "' setback='no' />" );
    popup_builder.add_command ( "Reset"           , "<modify_order job_chain='" + xml_encode_attribute( job_chain_name ) + "' order='" + xml_encode_attribute( order_id ) + "' action='reset' />" );
