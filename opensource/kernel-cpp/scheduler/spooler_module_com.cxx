// $Id: spooler_module_com.cxx 13442 2008-02-25 09:43:28Z jz $        Joacim Zschimmer, Zschimmer GmbH, http://www.zschimmer.com
/*
...
bool Scripting_engine_module_instance::load()
{
    ...
    {
        string text = _module->_text_with_includes.read_plain_text_element( element );
        if( text != "" )
        {
