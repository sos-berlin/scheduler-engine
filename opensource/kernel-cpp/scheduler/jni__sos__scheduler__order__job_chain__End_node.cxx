...
static jstring JNICALL string_1action(JNIEnv* jenv, jobject, jlong cppReference)
{
    Env env = jenv;
    try {
        ::sos::scheduler::order::job_chain::End_node* o_ = has_proxy< ::sos::scheduler::order::job_chain::End_node >::of_cpp_reference(cppReference,"::sos::scheduler::order::job_chain::End_node::string_action()");
