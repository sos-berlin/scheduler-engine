...
#if defined Z_64
#   if defined _DEBUG
#       import "x64/Debug/java.tlb"   rename_namespace("odl") raw_interfaces_only named_guids
#    else
#       import "x64/Release/java.tlb" rename_namespace("odl") raw_interfaces_only named_guids
#   endif
#else
#   if defined _DEBUG
