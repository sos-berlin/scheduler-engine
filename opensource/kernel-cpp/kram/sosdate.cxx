...
void test_date()
{
    ofstream out ( "/tmp/date" );
    { Sos_optional_date_time date = "27.11.95";          out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "27.11.1995";        out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1995-nov-27";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1995-NOV-27";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1995-Nov-27";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1995-11-27";        out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "19951127";          out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "951127";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "2.1.11";          out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "2.1.1911";        out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911-1-2";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911-jan-2";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "2-jan-1911";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "02-jan-1911";       out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911-1-2";        out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "19110102";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "110102";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "01/02/11";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1/2/11";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "jan/2/11";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "2. jan 1911";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911.01.02";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "11002";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911002";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "11365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1911365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "04365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1900365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "1904365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    { Sos_optional_date_time date = "2000365";            out << as_string( date, "dd.mm.yyyy" ) << endl;   }
    return 0;
}
...
#endif
BEGIN
    Sos_optional_date_time d ( 1995, 1, 5 );
    Sos_string str;
    Opt< Sos_optional_date_time >  optional_date = Sos_optional_date_time();

    d = optional_date;

    optional_date.object_load( "       " );

    d.object_load( Sos_string( "4.1.1995") );      d.object_store( &str );
  //d.object_load( Sos_string( "29.2.1993") );

    Sos_future_date future = Sos_optional_date_time( 1995,1,1 );
    Sos_past_date   past   = Sos_optional_date_time( 1995,1,1 );
    const char* p;

    try{ future.assign( p = "  29  .  2  .  00  " ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "6.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "5.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "4.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "4.1.84" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "4.1.85" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ future.assign( p = "4.1.86" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );

    try{ past.assign( p = "29.2.00" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "4.1.84" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "4.1.85" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "4.1.86" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "2.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "5.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
    try{ past.assign( p = "6.1.95" ); } catch( Xc x ) SHOW_MSG( p << ": " << x );
