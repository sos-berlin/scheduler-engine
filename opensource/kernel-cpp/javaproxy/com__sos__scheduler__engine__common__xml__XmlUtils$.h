...
#ifndef _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_XML_XMLUTILS$_H_
#define _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_XML_XMLUTILS$_H_
...
struct XmlUtils$ : ::zschimmer::javabridge::proxy_jobject< XmlUtils$ >, ::javaproxy::java::lang::Object {
  ...
  public:
    ...
    bool booleanXmlAttribute(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::org::w3c::dom::Element >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::String >& p1, jboolean p2) const;
    ...
    ::javaproxy::org::w3c::dom::NodeList xpathNodeList(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::org::w3c::dom::Node >& p0, const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::String >& p1) const;
  ...
  private:
    struct Lazy_class : ::zschimmer::abstract_lazy<XmlUtils$__class*> {
