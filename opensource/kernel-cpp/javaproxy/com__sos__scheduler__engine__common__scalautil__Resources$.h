...
#ifndef _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_SCALAUTIL_RESOURCES$_H_
#define _JAVAPROXY_COM_SOS_SCHEDULER_ENGINE_COMMON_SCALAUTIL_RESOURCES$_H_
...
struct Resources$ : ::zschimmer::javabridge::proxy_jobject< Resources$ >, ::javaproxy::java::lang::Object {
  ...
  public:
    ...
    ::javaproxy::java::lang::String resourceAsString(const ::zschimmer::javabridge::proxy_jobject< ::javaproxy::java::lang::String >& p0) const;
  ...
  private:
    struct Lazy_class : ::zschimmer::abstract_lazy<Resources$__class*> {
