...
public class Node implements Sister {
    ...
    public final OrderState getOrderState() {
        return OrderState.of(nodeC.string_order_state());
    }

    public final OrderState getNextState() {
        return OrderState.of(nodeC.string_next_state());
    }

    public final OrderState getErrorState() {
        return OrderState.of(nodeC.string_error_state());
    }
