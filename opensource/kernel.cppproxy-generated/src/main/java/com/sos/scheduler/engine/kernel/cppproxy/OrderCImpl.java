   ...
   implements com.sos.scheduler.engine.kernel.cppproxy.OrderC
{
    ...
    @Override public void set_state_string(java.lang.String p0) {
        com.sos.scheduler.engine.cplusplus.runtime.CppProxy.threadLock.lock();
        try {
            set_state_string__native(cppReference(), p0);
        }
        catch (Exception x) { throw com.sos.scheduler.engine.cplusplus.runtime.CppProxies.propagateCppException(x, this); }
        finally {
            com.sos.scheduler.engine.cplusplus.runtime.CppProxy.threadLock.unlock();
    ...
    private static native void set_state_string__native(long cppReference, java.lang.String p0);
