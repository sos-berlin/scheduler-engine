...
//  }
  ...
  private def javaObjectClassMethodCode = new CppCode {
    def headerCode = "    " + JavaBridge.namespace + "::Class* java_object_class_() const;\n"
    def sourceCode = JavaBridge.namespace + "::Class* " + name + "::java_object_class_() const { return _class.get(); }\n"
  }
